...
EmitterEntity.prototype.resetEmissionValues = function () {
    const self = this;
    const initVal = self.initValues;
    self.rateMin = initVal.rateMin;
    self.rateMax = initVal.rateMax;
    self.rateDecay = initVal.rateDecay;
    self.rateDecayMax = initVal.rateDecayMax;
    self.repeatRate = initVal.repeatRate;
    self.repeatDecay = initVal.repeatDecay;
    self.repeatDecayMax = initVal.repeatDecayMax;
};
